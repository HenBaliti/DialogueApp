...
import com.example.dialogueapp.FragmentsStudent.fragment_lesson_details_studentArgs;
...
public class fragment_lesson_details_teacher extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String lessonID = fragment_lesson_details_teacherArgs.fromBundle(getArguments()).getLessonId();
