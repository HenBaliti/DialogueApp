...
//                        Log.d("MSG",task.getResult().toString());
    ...
    public void uploadImage(Bitmap imageBmp, int id, Model.UploadImageListener listener){
        FirebaseStorage storage = FirebaseStorage.getInstance();
        final StorageReference imagesRef = storage.getReference().child("images").child(String.valueOf(id));
